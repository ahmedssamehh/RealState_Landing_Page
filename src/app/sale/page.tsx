...
/**
 * The sales collection. Structurally identical to `/rent` — same hero scene,
 * same choreography, same sections in the same order — but driven by
 * `saleProperties` and the `sale` copy tree rather than the rentals.
 *
    ...
    <>
      ...
      */}
      ...
      >
        ...
        <main id="main">
          <Hero ready={ready} copy={t.sale.hero} cta={t.sale.cta} />
          <IntroSection items={saleProperties} copy={t.sale.intro} />
          <ResidencesSection
            items={saleProperties}
            copy={t.sale.residences}
            onOpenResidence={openResidence}
            onOpenPhotos={openPhotos}
          />
          <LocationSection items={saleProperties} sectionCopy={t.sale.location} />
          <FinalCTA copy={t.sale.finalCta} />
        </main>
